...
sub root {
    global_tracer_cmp_easy(
        [{ operation_name => 'root', has_finished => false }],
        'root span started');
    ...
    global_tracer_cmp_easy(
        [
            { operation_name => 'root',  has_finished => false },
            { operation_name => 'child', has_finished => true },
        ],
...
sub child {
    global_tracer_cmp_easy(
        [
            { operation_name => 'root',  has_finished => false },
            { operation_name => 'child', has_finished => false },
        ],
...
global_tracer_cmp_easy(
    [
        { operation_name => 'root',  has_finished => true },
        { operation_name => 'child', has_finished => true },
    ],
    'all spans finished'
);
